...
# 5.5. Dictionaries
# aka "associative memories", "associative arrays", "hashes".
# Dictionaries are indexed by keys, which can be any immutable type.
# Think of a dictionary as an unordered set of key:value pairs that require the keys to be unique.
# You can create an empty dictionary with a pair of curly braces {}.
